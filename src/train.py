...
feat_true = data["train_tr"]
feat_false=data["train_fl"]
neg_dirg = data["RetrainNegativeGist"]
neg_dirh = data["RetrainNegativeHog"]
classi = data["Classifier"]
root_dir = data["Train"]
#classifier_loc = "E:\\Classifier_Gist2"
rec_control = 1
